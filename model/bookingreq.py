...
async def create_bookings(
    ...
    query = "START TRANSACTION; INSERT INTO guests (firstname, lastname) VALUES (%s, %s) INSERT INTO bookings (guest_id, purpose, daterequested, status) VALUES (LAST_INSERT_ID(), %s, %s, %s) COMMIT"
